...
with open(base_path+'datas/vectors/diffusion/comma/avec/step5/using_prompt.pkl', 'wb') as file:
    pickle.dump(result_5, file)

with open(base_path+'datas/vectors/diffusion/comma/avec/step10/using_prompt.pkl', 'wb') as file:
    pickle.dump(result_10, file)

with open(base_path+'datas/vectors/diffusion/comma/avec/step20/using_prompt.pkl', 'wb') as file:
    pickle.dump(result_20, file)

with open(base_path+'datas/vectors/diffusion/comma/avec/step30/using_prompt.pkl', 'wb') as file:
...
with open(base_path+'datas/vectors/diffusion/comma/img/step5/using_prompt.pkl', 'wb') as file:
    pickle.dump(result_5, file)

with open(base_path+'datas/vectors/diffusion/comma/img/step10/using_prompt.pkl', 'wb') as file:
    pickle.dump(result_10, file)

with open(base_path+'datas/vectors/diffusion/comma/img/step20/using_prompt.pkl', 'wb') as file:
    pickle.dump(result_20, file)

with open(base_path+'datas/vectors/diffusion/comma/img/step30/using_prompt.pkl', 'wb') as file:
    pickle.dump(result_30, file)